...
import type { ErrorHandler } from '@solid/community-server';
import type { ResponseWriter } from '@solid/community-server';
import { BasicRepresentation } from '@solid/community-server';
import { getLoggerFor } from '@solid/community-server'
import type { KeyValueStorage } from '@solid/community-server';
import { BadRequestHttpError, HttpError, OAuthHttpError } from '@solid/community-server';
...
import type { ClientCredentials } from '@solid/community-server';
import type { InteractionHandler } from '@solid/community-server';
import type { AdapterFactory } from '@solid/community-server';
 ...
 */
export class IdentityProviderFactory3 implements ProviderFactory {
  ...
  private async initConfig(): Promise<Configuration> {
    ...
    async function issueRefreshToken(ctx:KoaContextWithOIDC, client:any, code:any) {
